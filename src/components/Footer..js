...
import Heroku from '../Assets/heroku-vector-logo.png'
...
const herokuLink = 'https://dashboard.heroku.com/apps'
...
export default function Porfolio() {
  return (
    <footer style={styles.footer}>
      ...
      <a href={herokuLink}  target='_blank'><img src={Heroku} alt="linkedin" style={styles.img} ></img></a>
